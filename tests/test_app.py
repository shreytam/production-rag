"""Offline tests for app.api (FastAPI).
...
# The token-minting path these tests used to cover now lives in app/ui.py and is
# exercised end-to-end in tests/test_ui_console.py.
